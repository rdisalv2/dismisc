...
#' Read in an mdb file.
#'
#' A shortened version of Hmisc::mdb.get
#'
...
#' @param mdbexportArgs arguments to pass to mdb-export. See man mdb-export.
...
mdb_get <- function (file, tables = NULL, lowernames = FALSE, mdbexportArgs = "", ...)
{
